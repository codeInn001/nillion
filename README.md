...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dbazmrk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dbazmrk.containers.anotherwebservice.com/
...
```
git clone git@github.com:codeInn001/nillion.git
cd container-dbazmrk
```
...
```
docker attach container-dbazmrk
```
